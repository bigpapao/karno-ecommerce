 ...
 */
export const getQueryPerformanceSummary = () => {
  return queryTimings.getSummary();
};
 ...
 */
export const getSlowQueries = (collectionName, limit = 10) => {
  return queryTimings.getSlowestQueries(collectionName, limit);
};
